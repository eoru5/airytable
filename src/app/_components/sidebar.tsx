...
export default function Sidebar({
  ...
  return (
    <div className="flex h-full flex-col items-center justify-between border-r-1 border-neutral-200 bg-white px-2 py-6 md:min-w-[300px]">
      <div className="flex w-full flex-col gap-2">
        <Link
          href="/"
          className="flex cursor-pointer items-center justify-between rounded-sm px-4 py-2 font-light transition duration-200 ease-in-out hover:bg-neutral-200"
        >
          Home
          <svg
